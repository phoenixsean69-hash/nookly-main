...
`,
  ...
  if (
    content.includes("markLocalAsRead") ||
    content.includes(
      'markAsRead: markLocalAsRead',
    )
  ) {
    throw new Error(
      "Landlord notification screen validation failed: the old local mark-as-read call remains.",
    );
  }
...
console.log("");
console.log(
  "Landlord notification badge clear fix applied.",
);
console.log("");
console.log("Updated:");
...
console.log("");
console.log("The notification screen now:");
console.log(
  "- marks account-ID notifications as read",
);
console.log(
  "- marks user-document-ID notifications as read",
);
console.log(
  "- clears local notification unread state",
);
console.log(
  "- refreshes the homepage badge count to zero",
);
console.log("");
