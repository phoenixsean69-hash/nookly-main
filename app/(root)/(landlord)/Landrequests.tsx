...
interface RentalRequest {
  ...
  tenantEmail?: string;
  tenantPhone?: string;
  tenantScore?: number; // ✅ Added tenant score
  ...
  tenantIsIdVerified?: boolean; // ✅ Added ID verification status
...
export default function LandlordRequests() {
    ...
    try {
      ...
      const formattedRequests = await Promise.all(
        requestsResult.documents.map(async (doc) => {
          ...
          let tenantIsIdVerified = false;
          let tenantScoreBreakdown = null;
          ...
          const propertyDocument = propertiesById.get(
          ...
          return {
            ...
            tenantIsIdVerified: tenantIsIdVerified,
            tenantScoreBreakdown: tenantScoreBreakdown,
            status: doc.status,
  ...
  // Updated getStatusInfo to return appropriate icon and colors
      ...
      >
        <SafeAreaView style={{ flex: 1, backgroundColor: theme.background }}>
          ...
          >
            ...
            <View
              className="self-start px-4 py-2 top-3 rounded-full mb-4 flex-row items-center"
                  ...
                  <View className="flex-row items-start mb-3">
                    ...
                    <View className="flex-1">
                      <View className="flex-row justify-between items-start">
                        ...
                        {/* Status Badge with Icon */}
                        <View
                          className="px-3 py-1 rounded-full ml-2 flex-row items-center"
                          style={{ backgroundColor: statusInfo.bg }}
                        >
                          <Image
                            source={statusInfo.icon}
