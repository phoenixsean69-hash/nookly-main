...
const PROFILE_PAGE_CACHE_KEY = "tenant-profile";
            ...
            {loadingScore ? (
              ...
              <>
                ...
                <View className="flex-row items-center justify-between">
                  <View>
                    <Text
                      className="text-4xl font-rubik-bold"
                      style={{
                        color: getScoreColor(Math.round(tenantScore.overall)),
                      }}
                    >
                      {Math.round(tenantScore.overall)}
                    </Text>
                  ...
                  <View className="flex-row flex-wrap gap-2">
                    <View className="flex-1 min-w-[45%]">
                      <View className="flex-row items-center justify-between">
                        ...
                        >
                          {Math.round(
                            tenantScore.scoreBreakdown.idVerification,
                          )}
                          %
                        </Text>
                      </View>
                    ...
                    <View className="flex-1 min-w-[45%]">
                      <View className="flex-row items-center justify-between">
                        ...
                        >
                          {Math.round(
                            tenantScore.scoreBreakdown.landlordReviews,
                          )}
                          %
                        </Text>
                      </View>
                    ...
                    <View className="flex-1 min-w-[45%]">
                      <View className="flex-row items-center justify-between">
                        ...
                        >
                          {Math.round(
                            tenantScore.scoreBreakdown.paymentReliability,
                          )}
                          %
                        </Text>
                      </View>
