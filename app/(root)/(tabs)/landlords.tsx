...
type FilterKey = "all" | "hasProperties" | "topRated" | "mostViewed" | "accredited";
...
useEffect(() => {
  ...
  if (!landlordId || !landlords || landlords.length === 0 || autoOpened) return;

  console.log("🔍 Looking for landlordId:", landlordId);
  console.log("🔍 Available landlords:", (landlords as Landlord[]).map(l => ({
    $id: l.$id,
