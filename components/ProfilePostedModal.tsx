...
interface ProfilePostedModalProps {
  visible: boolean;
  onClose: () => void;
}

const ProfilePostedModal: React.FC<ProfilePostedModalProps> = ({
  visible,
  onClose,
}) => {
    ...
    >
      <View className="flex-1 justify-center items-center bg-black/50">
        ...
        >
          ...
          >
            <Ionicons name="send" size={40} color={theme.primary[300]} />
          </View>
          ...
          >
            Your profile has been successfully posted. Start matching now!
          </Text>
...
export default ProfilePostedModal;
