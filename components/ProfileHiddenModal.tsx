...
interface ProfileHiddenModalProps {
  visible: boolean;
  onClose: () => void;
}

const ProfileHiddenModal: React.FC<ProfileHiddenModalProps> = ({
  visible,
  onClose,
}) => {
    ...
    >
      <View className="flex-1 justify-center items-center bg-black/50">
        ...
        >
          ...
          >
            <Ionicons name="eye-off" size={40} color={theme.muted} />
          </View>
...
export default ProfileHiddenModal;
